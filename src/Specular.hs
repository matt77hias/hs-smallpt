...
reflectance0 n1 n2 = let sr = ((/) ((-) n1 n2) ((+) n1 n2))
                         in ((*) sr sr)

schlick_reflectance :: Double -> Double -> Double -> Double
schlick_reflectance n1 n2 c = let r0 = (reflectance0 n1 n2)
                                  in ((+) r0 ((*) ((-) 1.0 r0) ((**) c 5.0)))

ideal_specular_reflect :: Vector3 -> Vector3 -> Vector3
ideal_specular_reflect d n = (sub_v3v3 d (mul_dv3 ((*) 2.0 (dot_v3v3 n d)) n))

ideal_specular_transmit :: Vector3 -> Vector3 -> Double -> Double -> IO (Vector3, Double)
ideal_specular_transmit d n nout nin = let dRe = (ideal_specular_reflect d n)
                                           ...
                                           in case ((<) cos2_phi 0.0) of
                                                    ...
                                                    _    -> do
                                                                ...
                                                                let re = (schlick_reflectance nout nin c)
